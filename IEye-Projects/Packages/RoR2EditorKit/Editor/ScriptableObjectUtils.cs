...
namespace RoR2EditorKit
{
    ...
    public static class ScriptableObjectUtils
    {
        ...
        {
            ThunderKit.Core.Utilities.ScriptableHelper.SelectNewAsset(afterCreated);
        }
        ...
        {
            return ThunderKit.Core.Utilities.ScriptableHelper.EnsureAsset(assetPath, initializer);
        }
