...
/// @brief This will call \c AkSoundEngine.SetState() whenever the selected Unity event is triggered. For RRP this component could be set on a Unity collider to trigger when an object enters it.
/// \sa 
